...
export class UserDto {
  @ApiProperty({ example: '3f9d511a-1d54-4a2a-b732-47528e18dbcf', description: 'Unique identifier of the user' })
  id!: string;
  ...
  @ApiProperty({ example: '2026-06-23T04:24:47.000Z', description: 'Creation timestamp of the user account' })
  createdAt!: Date;
}
